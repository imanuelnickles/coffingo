...
<section class="content">
    <div class="row">
        <div class="col-md-8 ">
            ...
            @endif
                    ...
                    <form class="form-horizontal" id="product_new_form" role="form" method="POST" enctype="multipart/form-data" action="{{ route('product_store') }}">
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <span><em>(*) image width and height must be 500 px</em></span>
                                @if ($errors->has('image'))
                                    <span class="help-block">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-2 ">
                                ...
                                <button type="button" data-toggle="modal" data-target="#product_new_modal" class="btn btn-primary">
                                    Submit
                                </button>
 ...
 <div id="product_new_modal" class="modal fade" role="dialog" >
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" onclick="event.preventDefault();document.getElementById('product_new_form').submit();" class="btn btn-success" >Yes</button>
